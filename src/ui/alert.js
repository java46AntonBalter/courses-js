export default class Alert {
    ...
    showAlert() {
        ...
        <div class="alert alert-danger alert-dismissible fade show mt-5" role="alert">
            <strong>Error!</strong> Fiddlesticks!!!  Gee Whiz!!! d[o_0]b <br> Unfortunately, the server <a href=http://localhost:3500/courses>http://localhost:3500/courses</a> could not be reached
